$(function(){
    ...
    ipc.on('show:left', function(arg) {
        if(arr.indexOf(arg)==-1){
            var html = '<li><img src="img/logo.png"><span class="nickname">'+arg+'</span></li>';
    ...
    $(document).on("dblclick","#typeId",function(){
    ...
    w.CHAT = {
        ...
        init:function(username){
            ...
            this.socket.on('message', function(obj){
                ...
                if(isme){
                    var html = '<div class="mess-right"><img src="img/logo.png"><div class="mess-cont">'+
                        '<div>'+obj.content+'</div></div></div>';
                } else {
                    var html = '<div class="mess-left"><img src="img/logo.png"><div class="mess-cont">'+
                        '<div>'+obj.content+'</div></div></div>';
                }
                $('.message').append(html);
            });
